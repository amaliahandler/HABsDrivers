...
The code that uses the models to make predictions is available at the file path found by running

```{r}
system.file("inst/scripts/predictor-analysis.R", package = "HABsDrivers")
```
