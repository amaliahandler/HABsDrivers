...
# Lake Depth Testers with large and med lakes ----------------------------------
...
lake_depth <- do.call(rbind, lapply(COMID, morph_it_y, wbd_copy, wbd_copy$z))
...
depth <- morph_it(testtest, testtest$z)
