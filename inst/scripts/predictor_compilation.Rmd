...
# join ecoregion data to exisiting predictor data
...
# simplify and aggregdate variables
ncldMas <- ncldMas |>
...
# and merging with exisitng predictor dataset by COMID 
PredData <- ncldMas |>
...
# join fetch data with exisiting predictor data set 
...
# replace missing fetch values in exisiting predictor dataset with ones populated from lakemorpho
