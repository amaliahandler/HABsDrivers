...
PredData <- PredData |>
  ...
  dplyr::select(c(COMID, n_dev_inputs, n_farm_inputs, p_dev_inputs, p_farm_inputs,
                  BFIWs, MAXDEPTH,lakemorpho_fetch, lake_area, ad_ratio, drain_ratio, WSAREASQKM,
...
# bring in df
# thresholds <- read_csv("C:/Users/MREYNO04/OneDrive - Environmental Protection Agency (EPA)/Profile/REPOS/HABsDrivers/thresholds.csv")
# 
# used_thresholds <- thresholds |>
#   rename(AG_ECO3 = ecoregion) |>
#   dplyr::select(-c(cyano_75, micx_nondetect))
# 
saveRDS(used_thresholds, file = "C:/Users/mreyno04/OneDrive - Environmental Protection Agency (EPA)/Profile/REPOS/HABsDrivers/inst/eco_habs_thresholds.rds")
