...
Sys.time()
Pred <- predict(object = model_cyano_nolakes, newdata = PredData, 
...
# run the micx model
Sys.time()
MicxPred <- predict(object = model_micx_nolakes, newdata = PredData, 
                local = list(method = 'all', parallel = TRUE, ncores = 48),
                interval = 'prediction') # run with 95% prediction intervals
Sys.time()

# perform transformation on the micx data 
micx_pred_df <- final_pred %>%
  mutate(pred_micx = MicxPred,
...
load(file = "C:/Users/mreyno04/OneDrive - Environmental Protection Agency (EPA)/Profile/REPOS/HABsDrivers/inst/source_data/predictions/cyano_preds.rda")

# load micx predictions
load(file = "C:/Users/mreyno04/OneDrive - Environmental Protection Agency (EPA)/Profile/REPOS/HABsDrivers/inst/source_data/predictions/micx_preds.rda")
