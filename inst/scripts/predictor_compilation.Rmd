...
PredData <- PredData |>
  mutate(ad_ratio = ifelse(ad_ratio == Inf, 0.0001, ad_ratio))

# Pull out 1500 rows randomly to test variable normality
test <- PredData |>
  st_drop_geometry() |>
  ungroup()
...
# non-normal distribution, preliminary test with Kruskal-Wallis rank sum test
