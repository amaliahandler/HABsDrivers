...
# save as an object just in case
# saveRDS(PredData, file = "C:/Users/mreyno04/OneDrive - Environmental Protection Agency (EPA)/Profile/REPOS/HABsDrivers/inst/source_data/predictions/PredData_2026.rds")

```
# Clean predicition data
```{r Rename predictions}
...
# set thresholds based on NLA data
```{r Thresholds, eval = FALSE}

library(rstatix)
habs <-  load(paste0(here(), "/data/habs.rda"))
...
```{r Nutr/Risk Categories, eval = FALSE}
