...
habs_mod <- habs |>
  select(B_G_DENS, Precip8110Ws, Tmean8110Ws, precip_mean_month, temp_mean_month, BFIWs, MAXDEPTH, lakemorpho_fetch, p_dev_inputs, p_farm_inputs, n_farm_inputs, n_dev_inputs, N_Total_Inputs, p_total_inputs, fst_ws, wet_ws, AG_ECO3, UNIQUE_ID, DSGN_CYCLE) |>
  drop_na()
...
# Save the models
# saveRDS(cy_list, "./inst/model_objects/cyano_mods_nolakedata_20260504.rds")
...
# Save the model comparison table for inclusion in supplement
saveRDS(cmods_ml_nolake, "./inst/model_objects/cyano_mod_compare_nolakedata_20260504.rds")
