...
# What about a ration of TN and TP?
habs <- mutate(habs, np_ratio = NTL/PTL)
...
# How does additional dissolved water data improve the model?
cy5 <- run_cyano_ml(mod_vars = c("NTL", "NITRATE_N", "DOC", "PH", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH", "lakemorpho_fetch"), interact = NULL)
