...
# What about no nutrient inventory variable?
cy0 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH"), interact = NULL)

cy6 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH", "AG_ECO3"), interact = "AG_ECO3 * NTL")
...
cyano_nla_comp <- do.call(rbind, lapply(list(cy0, cy1, cy2, cy3, cy4, cy5, cy6, cy7), function(mod){
  cv_res <- loocv(mod)
  cv_res$AIC <- AIC(mod)
...
cy_list <- list(cy1, cy3, cy4, cy5, cy6, cy7)
...
cy_res_table <- glances(cy1, cy3, cy4, cy5, cy6, cy7) |>
  arrange(model) |>
  select(model, n, p, npar, AIC) |>
  cbind(mods_loocv) |>
