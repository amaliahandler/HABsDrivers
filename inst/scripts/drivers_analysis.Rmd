...
glances(mx1, mx2, mx3, mx4, mx5, mx6, mx7)

# Make a list of the independent error models to compare
mx_ie_mods <- list(mx1, mx2, mx3, mx4, mx5, mx6, mx7)
...
mx_ie_modcomp <- glances(mx1, mx2, mx3, mx4, mx5, mx6, mx7) |>
  arrange(model) |>
