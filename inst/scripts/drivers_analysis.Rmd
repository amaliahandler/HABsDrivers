...
# Full, best model?
cy1 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH","p_farm_inputs"), interact = NULL)

# Compare EVAP_INFL versus ecoregion. 
cy2 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "Precip8110Ws", "Tmean8110Ws", "AG_ECO3", "MAXDEPTH","p_farm_inputs"), interact = NULL)

# Does TN or TP fit better?
cy3 <- run_cyano(mod_vars = c("PTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH","p_farm_inputs"), interact = NULL)

# Monthly mean temperature and precipitation or climate normals?
# cy4 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "precip_mean_month", "temp_mean_month", "EVAP_INFL", "MAXDEPTH","p_farm_inputs"), interact = NULL)

# Does including fetch improve the model?
cy5 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH","p_farm_inputs", "lakemorpho_fetch"), interact = NULL)

# Does another nutrient inventory variable fit better?
cy6 <- run_cyano(mod_vars = c("NTL", "NITRATE_N", "NITRATE_DET", "AMMONIA_N", "DOC", "PH", "TURB", "TEMPERATURE", "Precip8110Ws", "Tmean8110Ws", "EVAP_INFL", "MAXDEPTH","p_dev_inputs"), interact = NULL)


# Compile AIC and loocv data for each model
cyano_nla_comp <- do.call(rbind, lapply(list(cy1, cy2, cy3, cy5, cy6), function(mod){
  cv_res <- loocv(mod)
  cv_res$AIC <- AIC(mod)
