...
ggplot() + 
  ...
  geom_sf(data = arrange(dat_final, preds), 
...
habs_mod <- habs |>
  select(B_G_DENS, UNIQUE_ID, DSGN_CYCLE,
         Precip8110Ws, Tmean8110Ws,
         p_dev_inputs, p_farm_inputs, n_farm_inputs, n_dev_inputs, N_Total_Inputs, p_total_inputs, 
         BFIWs, MAXDEPTH, lakemorpho_fetch, 
         fst_ws, KffactWs, AG_ECO3) |>
  drop_na()
