...
com_vars <- c("NITRATE_N", "DOC", "PH", "MAXDEPTH", "EVAP_INFL", "lakemorpho_fetch")

# Which models are included in the table?
cy_list <- list(cy1, cy2, cy3, cy4, cy5, cy6, cy7, cy8)
...
cy_res_table <- glances(cy1, cy2, cy3, cy4, cy5, cy6, cy7, cy8) |>
  arrange(model) |>
