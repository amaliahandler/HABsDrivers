...
#### In-Lake Conditions Absent

When in-lake conditions were excluded from the candidate list of model covariates, more of the watershed nutrient input variables were included in the final models. The cyanobacteria abundance was positively associated with farm N inputs and developed land cover P inputs. Likewise the probability of microcystin detection was positively associated with farm P inputs and developed land N inputs. In addition the microcystin model included a negative association with forested land cover.

For lake morphology, deeper lakes had lower cyanobacteria and probability of microcystin detection and lakes with longer fetch had higher cyanobacteria and probability of microcystin.

Among geographic setting variables, the and higher baseflow index was associated with lower cyanobacteria abundance and lower probability of the microcystin detection. Similar to models with in-lake conditions, lake watersheds with lower mean annual precipitation and higher mean annual air temperature were correlated with higher cyanobacteria abundance and probability of microcystin. Both the PLNLOW and EHIGH ecoregions had higher probability of microcystin compared to the WMTNS ecoregion. No ecoregional differences were detected in the final model for cyanobacteria abundance nor were there interaction terms included in the final models for either response variable.
