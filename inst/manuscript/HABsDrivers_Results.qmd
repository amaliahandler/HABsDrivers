...
ggarrange(plotlist = list(cyan_stdresid_map, micx_stdresid_map), ncol = 1, nrow = 2, labels = c("a. Cyanobacteria", "b. Microcystin"), align = "h")
...
ggarrange(plotlist = list(cyan_spde_map, micx_spde_map), ncol = 1, nrow = 2, labels = c("a. Cyanobacteria", "b. Microcystin"), align = "h")
