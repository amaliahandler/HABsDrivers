...
cy_tbox <- ggplot(n, aes(fill=cyano_ecocond, y=n, x=AG_ECO3)) + 
  ...
  geom_text(data = w_n, 
            aes(label = paste0(percent, "%"), y = 22000),
            size = 4) +
...
m_tbox <- ggplot(m, aes(fill=micx_ecocond, y=n, x=AG_ECO3)) + 
  ...
  geom_text(data = subset(m, AG_ECO3 == "EHIGH" | AG_ECO3 == "PLNLOW" | AG_ECO3 == "WMTNS" & micx_ecocond == "Below"),
            ...
            position = position_stack(vjust = 0.5)) +
  geom_text(data = w_m, 
            aes(label = paste0(percent, "%"), y = 20000),
            size = 4) +
...
ggsave("inst/manuscipt/figures/thresholds_boxplot.tiff", width = 8, height = 4, units = "in", dpi = 600)
...
ggsave("inst/manuscipt/figures/drainage_ratio_boxplot.tiff", width = 8, height = 6, units = "in", dpi = 600)
