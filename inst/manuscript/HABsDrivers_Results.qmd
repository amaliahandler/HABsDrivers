...
habs |>
  ...
  mutate(tot_n_inputs = N_Fert_Farm + N_livestock_Waste + N_Total_Deposition + N_Fert_Urban + N_Human_Waste + N_CBNF,
         ...
         nodep_n_inputs = N_Fert_Farm + N_livestock_Waste + N_Fert_Urban + N_Human_Waste + N_CBNF,
  ...
  mutate(includes = c(rep("N/P Farm Fert, N/P Manure, N/P Human Waste, N/P Dev Fert, N CBNF", 2),
                   rep("N/P Farm Fert, N/P Manure, N/P Human Waste, N/P Dev Fert, N/P Dep, N CBNF", 2),
                   rep("N Farm Fert, N Manure, N CBNF, P Dev Fert, P Human Waste", 2),
                   rep("P Farm Fert, P Manure, N Human Waste, N Dev Fert", 2),
                   rep("N/P Farm Fert, N/P Manure, N/P Human Waste, N/P Dev Fert, N CBNF", 2))) |>
