...
# p value large -> no evidence of autocorrelation
# Should I run this with the non-spatial models? I don't currently have these saved, so I would need to rerun them

# standardized residuals without spatial dependence modeled
# spmod2 <- splm(sulfate ~ 1, data = sulfate, spcov_type = "exponential")
 
# large p-value -> no evidence of autocorrelation
# moran.test(rstandard(spmod2), lw)
