...
est_header <- data.frame(
  ...
  line2 = c("Model", rep("In-Lake Conditions", 4)),
  line3 = c("Model", c(rep("Present", 2), rep("Absent", 2))),
  line4 = c("Corvariates", rep(c("Cyanobacteria", "Microcystin"), 2))
)
...
est_and_sign |>
  ...
  merge_h(part = "header", i = 2) |> 
  theme_booktabs(bold_header = TRUE) |>
  bg(bg = colorer,
     j = ~ . -Covariates, # All columns in the body except for the first one
     part = "body") |>
  bg(j = c(4:5), i = c(1:7), bg = "#606060") |> # Covariates that weren't available to the models
  theme_box() |>
