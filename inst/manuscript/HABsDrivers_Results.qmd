...
bf_model <- readRDS(paste0(here(), '/inst/model_objects/bf_model_cyano.rds'))
anova(bf_model)

#ad_model <- splm(log10(ad_ratio) ~ all_pred, comp_cyano, spcov_type = "exponential")
ad_model <- readRDS(paste0(here(), '/inst/model_objects/ad_model_cyano.rds'))
anova(ad_model)

#precip <- splm(log10(Precip8110Ws) ~ all_pred, comp_cyano, spcov_type = "exponential")
precip <- readRDS(paste0(here(), '/inst/model_objects/precip_model_cyano.rds'))
anova(precip)
...
bfm_model <- readRDS(paste0(here(), '/inst/model_objects/bf_model_micx.rds'))
anova(bfm_model)

#adm_model <- splm(log10(ad_ratio) ~ all_pred, comp_micx, spcov_type = "exponential")
adm_model <- readRDS(paste0(here(), '/inst/model_objects/ad_model_micx.rds'))
anova(adm_model)

#precipm <- splm(log10(Precip8110Ws) ~ all_pred, comp_micx, spcov_type = "exponential")
precipm <- readRDS(paste0(here(), '/inst/model_objects/precip_model_micx.rds'))
anova(precipm)
