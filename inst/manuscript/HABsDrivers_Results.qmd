...
## Creating a temporary set of tables for comparing the revised in-lake and no-lake models
tabs <- c("cyano_mod_compare_withlakedata_20260512.rds",
          # "micx_iemod_compare_withlakedata_20260420.rds",
          "micx_spmod_compare_withlakedata_20260508.rds",
          "cyano_mod_compare_nolakedata_20260511.rds",
          "micx_spmod_compare_nolakedata_20260511.rds")

## Manual edits to tables since it takes so long to rerun all the models and diagnostics
# cyano_withlake_compare <- readRDS(paste0(here(), "./inst/model_objects/", "cyano_mod_compare_withlakedata_20260429.rds"))|>
#   mutate(
#     distinct_vars = str_replace(distinct_vars, "AG_ECO3PLNLOW, AG_ECO3EHIGH", "AG_ECO3")
#   ) |>
#   saveRDS(paste0(here(), "./inst/model_objects/", "cyano_mod_compare_withlakedata_20260512.rds"))

# micx_sp_compare <- readRDS(paste0(here(), "./inst/model_objects/", "micx_spmod_compare_withlakedata_20260423.rds"))|>
#   mutate(
#     distinct_vars = case_when(
#     model == "mx2_sp" ~ "Precip8110Ws, Tmean8110Ws",
#     model != "mx1_sp" ~ paste0(distinct_vars, ", Precip8110Ws, Tmean8110Ws"),
#     TRUE ~ distinct_vars
#   ),
#   common_vars = str_remove(common_vars, " Precip8110Ws, Tmean8110Ws,"),
#   distinct_vars = str_replace(distinct_vars, "AG_ECO3PLNLOW, AG_ECO3EHIGH", "AG_ECO3")
#   ) |>
#   saveRDS(paste0(here(), "./inst/model_objects/", "micx_spmod_compare_withlakedata_20260508.rds"))

# Manual edits to tables since it takes so long to rerun all the models and diagnostics
# cyano_nolake_compare <- readRDS(paste0(here(), "./inst/model_objects/", "cyano_mod_compare_nolakedata_20260506.rds"))|>
#   mutate(
#     distinct_vars = str_replace(distinct_vars, ", AG_ECO3PLNLOW, AG_ECO3EHIGH", "")
#   ) |>
#   saveRDS(paste0(here(), "./inst/model_objects/", "cyano_mod_compare_nolakedata_20260511.rds"))
# 
# # Manual edits to tables since it takes so long to rerun all the models and diagnostics
# micx_nolake_compare <- readRDS(paste0(here(), "./inst/model_objects/", "micx_spmod_compare_nolakedata_20260507.rds"))|>
#   mutate(
#     distinct_vars = str_replace(distinct_vars, ", AG_ECO3PLNLOW, AG_ECO3EHIGH", "")
#   ) |>
#   saveRDS(paste0(here(), "./inst/model_objects/", "micx_spmod_compare_nolakedata_20260511.rds"))
...
saveRDS(mod_comp_tabs, here("inst", "model_objects", "model_tables_update_20260511.rds"))
