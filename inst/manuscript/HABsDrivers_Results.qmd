...
#| fig-width: 6
#| fig-height: 4
#| fig-cap: "Predicted cyanobacteria cell abundance in the CONUS."
...
#| fig-width: 6
#| fig-height: 4
#| fig-cap: "Predicted probabilty of microcystin detection above 0.1ug/L in the CONUS."
...
comp_micx <- PredData |>
  dplyr::select(-c(pred_cyano, cyano_transform)) |>
  drop_na(pred_micx)
...
comp_cyano <- PredData |>
  dplyr::select(-c(pred_micx, micx_transform)) |>
  drop_na(pred_cyano)
...
#| fig-width: 6
#| fig-height: 4
#| fig-cap: "Density distibutions of precitpitation in the four nutrient/risk categories."
...
#| label: density-baseflow
#| fig-width: 6
#| fig-height: 4
#| fig-cap: "Density distibutions of baseflow percents in the four nutrient/risk categories."
...
```{r density plots - a:d ratio, eval = FALSE}
#| label: density-area-depth
#| fig-width: 6
#| fig-height: 4
#| fig-cap: "Density distibutions of area:depth ratio in the four nutrient/risk categories."
