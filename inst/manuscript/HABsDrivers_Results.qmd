...
```{r thresholds bar chart}
#| fig-cap: "US Lakes in our dataset that fall above or below cyanobacteria abundance and microcystin detection thresholds for each ecoregion."
...
```{r drainage ratio table, message = FALSE}
...
# ggsave("inst/figures/drainage_ratio_boxplot.tiff", width = 8, height = 6, units = "in", dpi = 600)
