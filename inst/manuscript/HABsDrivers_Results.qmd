...
```{r thresholds table}
#| tbl-cap: "Cyanobacteria abundance thresholds are in the units of cells m/L, microcystin thresholds are the probabilty of detecting microcystin above the threshold of  0.1 μg/L at the ecoregion level"
...
dr_model_cy <- readRDS(paste0(here(), '/inst/model_objects/dr_model_cy26.rds'))
#dr_model_cy <- splm(log(drain_ratio) ~ cyano_cat, PredData, spcov_type = "exponential")
anova(dr_model_cy)

dr_model_mx <- readRDS(paste0(here(), '/inst/model_objects/dr_model_mx26.rds'))
#dr_model_mx <- splm(log(drain_ratio) ~ micx_cat, PredData, spcov_type = "exponential")
anova(dr_model_mx)

bf_model_cy <- readRDS(paste0(here(), '/inst/model_objects/bf_model_cy26.rds'))
#bf_model_cy <- splm(BFIWs ~ cyano_cat, PredData, spcov_type = "exponential")
anova(bf_model_cy)

bf_model_mx <- readRDS(paste0(here(), '/inst/model_objects/bf_model_mx26.rds'))
#bf_model_mx <- splm(BFIWs ~ micx_cat, PredData, spcov_type = "exponential")
anova(bf_model_mx)

ad_model_cy <- readRDS(paste0(here(), '/inst/model_objects/ad_model_cy26.rds'))
#ad_model_cy <- splm(log(ad_ratio) ~ cyano_cat, PredData, spcov_type = "exponential")
anova(ad_model_cy)

ad_model_mx <- readRDS(paste0(here(), '/inst/model_objects/ad_model_mx26.rds'))
