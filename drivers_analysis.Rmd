...
ecor_test3 <- splm(log10(CHLA_CYANO + 1) ~ NTL + precip_mean_month,
                         data = drop_na(habs, CHLA_CYANO, NTL, precip_mean_month),
                         spcov_type = "exponential",
...
try_vars <- c(nla_ind_vars[!nla_ind_vars %in% c("AMMONIA_N", "NITRATE_N", "STRATIFIED")], c("agr_ws", "Precip_Minus_EVTWs", "BFIWs", "SlopeWs"))
