...
# Piling in non-inventory watershed variables improves the amount of variation explained, but not by much. Agriculture and developed land cover in the watershed is more associated with cyanobacteria that any of the nutrient inventory variabels. 

# There are a few extremely high observations of N farm inputs. Perhaps try log-transforming this covariate?
...
mod_vars <- c("agr_ws", "dev_ws", "dev_ws", "wet_ws", "BFIWs", "Tmean8110Ws", "Precip8110Ws", "lakemorpho_fetch", "log10(n_farm_inputs)", "AG_ECO3")
