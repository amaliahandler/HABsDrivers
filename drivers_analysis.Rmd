...
dep_vars     <- c("B_G_DENS", "MICX", "CYLSPER", "CHLA_RESULT")
...
create_formula(dep_var, all_vars, log = T)

# Dropping non-developed area of the watershed due to issues of colinearity with deveoped area. Also dropping nitrate data since it is missing for a large number of observations.
...
# Nested random effects performed the best
