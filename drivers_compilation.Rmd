...
habs_comb <- nla_long %>%
  ...
  left_join(nla_nlcd, by = c("UNIQUE_ID", "DSGN_CYCLE")) %>%
  
  # Add watershed characterstics from LakeCat
  left_join(select(ws_char, UNIQUE_ID:SlopeWs), by = c("UNIQUE_ID", "DSGN_CYCLE")) %>%
