...
nni_mean <- nni0712 |>
  ...
  filter(!type %in% c("AG_N2O_INPUTS", "AG_N2O_SOIL", "Agricultural_NHy", "Combustion_transportation", "Combustion_utility", "Complete_Mass_Balance_AG", "Imp_Balance", "Imp_Ratio", "NUE_AG", "Other_emissions", "Low_P", "human_food_demand_kg", "human_nonfood_demand_kg", "kg_ww")) |>
