...
# For NITRATE, values of 0.005 in 2007 should be recoded as NA. This seems to be what was reported for anything below the reporting limit of 0.02.
...
nni_mean <- nni0712 |>
  ...
  filter(!type %in% c("N_AG_N2O_INPUTS", "N_AG_N2O_SOIL", "N_Agricultural_NHy", "N_Combustion_transportation", "N_Combustion_utility", "N_Complete_Mass_Balance_AG", "N_Imp_Balance", "N_Imp_Ratio", "N_NUE_AG", "N_Other_emissions", "P_Low_P", "P_human_food_demand_kg", "P_human_nonfood_demand_kg", "P_kg_ww")) |>
